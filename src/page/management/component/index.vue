    ...
    <el-container>
        ...
        <el-container>
                        ...
                        <el-menu
                            ...
                            <el-submenu index="1">
                                ...
                                <el-menu-item-group>
                                    ...
                                    <el-menu-item index="1-1">变量</el-menu-item>
                                </el-menu-item-group>
                                <el-menu-item-group title="静态">
                                    <el-menu-item index="1-2">图片</el-menu-item>
                                </el-menu-item-group>
                                <el-menu-item-group title="控制">
                                    <el-menu-item index="1-3">开关</el-menu-item>
                                    <el-menu-item index="1-4">按钮</el-menu-item>
                                    <el-menu-item index="1-5">滑块</el-menu-item>
                                </el-menu-item-group>
                            </el-submenu>
                        </el-menu>
                    </el-col>
            ...
            <el-main style="padding: 0 0 0 15px;">
                <el-row >
                    <!--<h3>组件列表</h3>-->
                   <!-- <el-row style="display: flex;flex-flow: row nowrap;">
                        <i class="el-icon-plus" style="margin-left: 20px;font-size: 1.5em;"
                    ...
                    <el-row>
                        <el-form :inline="true" :model="formInline" class="demo-form-inline">
                            ...
                            <el-form-item>
                                ...
                                <i class="el-icon-search" style="margin-left: 20px;font-size: 1.5em;"
                                   @click="dialogFormVisible = true"></i>
                        ...
                        <el-form ref="form" :model="form" label-width="80px">
                            ...
                            <el-form-item label="组件类型">
                                <el-select v-model="form.region" placeholder="请选择组件类型" style="width: 100%;">
                                    ...
                                    <el-option label="监控" value="shanghai"></el-option>
                                </el-select>
                            </el-form-item>
