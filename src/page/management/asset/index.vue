            ...
            >
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        ...
                        <el-button icon="el-icon-more" @click="dialogVisible = true" circle></el-button>
                        ...
                        <!--<el-popover
                                ...
                                width="120"
                                trigger="click">
                            &lt;!&ndash;<el-button type="success" icon="el-icon-check" circle></el-button>
                            <el-button type="info" icon="el-icon-message" circle></el-button>
                            <el-button type="warning" icon="el-icon-star-off" circle></el-button>&ndash;&gt;
                            <ul>
                                <li><el-button type="success" icon="el-icon-check" circle></el-button></li>
